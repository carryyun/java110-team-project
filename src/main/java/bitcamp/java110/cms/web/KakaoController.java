...
public class KakaoController {
  ...
  public KakaoController(AuthService authService, NoticeService noticeService, CsService csService
  // ,ClassFileService cfileService
      , MentorFileService mfileService, MentorLicenseService mlicnService,
      ProductTimetableService productTimetableService, ReportService reportService) {
  ...
  @PostMapping("login")
  public String login(String type, String email, String password, String save,
  ...
  @RequestMapping("kakao")
  public void kakao(String email, String id, String profile_image, String nickname,
      HttpSession session) {
