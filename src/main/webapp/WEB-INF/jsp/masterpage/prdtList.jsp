...
<a href="#"
                    ...
                    <div id="navbar" class="collapse">
                       <ul>
                            ...
                            <li><a onclick="location.href='reportFinishList'" data-nav-section="5">신고
                                    완료 목록</a></li>
                            <li><a onclick="location.href='prdtList'" data-nav-section="6" style=" color: #2c98f0; font-weight:bold;">전체
                                    상품 목록</a></li>
            ...
            <section class="colorlib-experience" data-section="6">
                    <div class="colorlib-narrow-content">
                        ...
                        <h1 class="colorlib-heading">전체 상품 목록</h1>
                            <hr />
                            ...
                            <form action="#" method="get">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="system-search" name="q"
                                        placeholder="Search for" required style="height:48px; font-size:20px;"> <span
                                        class="input-group-btn">
                                        <button type="submit" class="btn btn-default" style="border:1px solid silver;">
