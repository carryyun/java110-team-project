...
.popup .close:hover .popupH .close:hover {
    color: #06D85F;
}

.popup .content, .popupH .content {
    max-height: auto;
    overflow: auto;
    height: 550px;
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div>
            <span style="font-size: 45px; position: relative;"><strong>멘토
                    신청 목록</strong></span>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <table class="table table-list-search">
                ...
                <tbody>
                    <c:forEach items="${MentorRequestList}" var="ml"
                        varStatus="i">
                        <tr id="rmv${ml.no}">
                            <td class="text-center"><input
                                type="checkbox" id="men-ck"
                                class="men-ck" name="men-ck"
                                value="${ml.no}"></td>
                            <td class="text-center">${i.count}</td>
                            <td class="text-center"><a
                                class="button" href="#popup${i.count}">${ml.nick}(${ml.name})</a></td>
                            <td class="text-center">${ml.phone}</td>
                            <td class="text-center"><c:forEach
                                    items="${ml.mentorTag}" var="mt"
                                    varStatus="m">
                                    ${mt.name}
                                    <c:if test="${!m.last}">
                                        ,
                    ...
                    <a class="carousel-control-prev"
                        href="#carousel-Create${i.index}" role="button"
                    ...
                    <div class="col-lg-6 mx-auto">
                        <h3>자격증</h3>
                        <div class="pic1">
                            <div id="carousel-Certificate${i.index}"
                                class="carousel slide"
                                data-ride="carousel">
                    ...
                    <button type="button" class="btn btn-primary"
                        id="mas-p1" name="Y" value="${ml.no}"
                        onclick="stat(value,name)">승락</button>
                    <button type="button" class="btn btn-primary"
                        id="mas-p2" name="N" value="${ml.no}"
    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-12" id="btn">
                <button type="button" class="btn btn-primary"
                    id="mas-btn" onclick="checkItem()">멘토 신청 반려</button>
            </div>
        </div>
    </div>
</div>